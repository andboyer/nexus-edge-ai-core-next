...
/// in that case the middleware falls back to loopback-or-env
...
/// 3. No secret configured AND peer is loopback → allow.
/// 4. No secret configured AND `NEXUS_ADMIN_BEARER_ALLOW_REMOTE=1` → allow.
/// 5. Otherwise → 401.
